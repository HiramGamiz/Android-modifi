...
public class UrlHelper {
    ...
    public static final String GET_CASES_SUPERVISOR_URL = "https://grupozeta--Dev1.cs95.my.salesforce.com/services/apexrest/mobile/orders_supervisor?IdSupervisor=%1$s";
    ...
    public static final String ADMIN_PASS = "Tesselar2018";
